...
<div class="banner-top">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item  menu__item--current"><a href="gallery.php">Gallery</a></li>
	...
	</div><section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
<center>
		  <p class="about-para-w3ls">Welcome to Our Great city <br>Here is a brief Imagery and Gallery of  Our Great City <br><br>This Great City is Called the Dream Town City.Dream Town City is<strong>&nbsp;4004 square kilometres&nbsp;</strong>&nbsp;on the face of the Earth.It has a larger Population size of <strong>40Million</strong> 
